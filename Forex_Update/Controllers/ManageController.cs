...
namespace Forex_Update.Controllers
{
    ...
    public class ManageController : Controller
    {
        ...
        [HttpPost]
        public JsonResult editporfile(string firstName, string lastName, string email, string phone)
        {
        ...
        public ActionResult ChangePassword()
        {
            ...
            ViewBag.Promocode = customer.Promocode;
            ViewBag.Wallet = customer.Btcwallet;
        ...
        public async Task<ActionResult> ChangePassword(ChangePasswordViewModel model)
        {
            ...
            if (result.Succeeded)
            {
                customer.showpassword = model.NewPassword;
                db.SaveChanges();
                var user = await UserManager.FindByIdAsync(User.Identity.GetUserId<int>());
                if (user != null)
                {
