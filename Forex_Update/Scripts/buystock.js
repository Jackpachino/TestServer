...
// Example of calling getstock() after updating 'stockSelect' dynamically
function updateStockSelectAndFetch(symbol) {
    document.getElementById('stockSelect').textContent = symbol;
    getstock(); // Call after setting the new symbol
}
...
function updateTotalVolume() {
    ...
    fetch(`/stock/getEntirestock?stock=${selectedstock}`)
...
function fetchData(page) {
    ...
    fetch(`/tradings/getjsonlistStock?page=${page}&pageSize=${pageSize}`)
        .then(response => response.json())
        .then(data => {
...
function fetchTradingData(page) {
    ...
    fetch(`/tradings/getalljsonStock?page=${page}&pageSize=${pageSize}`)
        .then(response => response.json())
        .then(data => {
